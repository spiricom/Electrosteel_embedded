...
module CapSense_CSD_v3_50_4 (
	...
	cy_psoc3_port_v1_0
		#(.width(12),
		  ...
		  .pin_aliases({"Button4__BTN,But","ton3__BTN,Button","2__BTN,Button1__","BTN,Button0__BTN",",Button5__BTN,Bu","tton6__BTN,Butto","n7__BTN,Button8_","_BTN,Button9__BT","N,Button10__BTN,","Button11__BTN"}),
		  .access_mode("HW_ONLY"),
		  .layout_mode("NONCONTIGUOUS"),
		  .port_mode("ANALOG"),
...
module SPI_Master_v2_50_7 (
	...
	cy_clock_v1_0
		#(.id("04077077-9fcd-4e27-b911-3586a8a7e496/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
    ...
    defparam AMux_1_CYAMUXSIDE_A.muxin_width = 5;
    defparam AMux_1_CYAMUXSIDE_A.init_mux_sel = 5'h0;
    ...
    defparam AMux_1_CYAMUXSIDE_B.muxin_width = 5;
    defparam AMux_1_CYAMUXSIDE_B.init_mux_sel = 5'h0;
	...
	wire [0:0] tmpOE__otherUnused_net;
	wire [0:0] tmpFB_0__otherUnused_net;
	wire [0:0] tmpIO_0__otherUnused_net;
	wire [0:0] tmpINTERRUPT_0__otherUnused_net;
	electrical [0:0] tmpSIOVREF__otherUnused_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		otherUnused
		 (.oe(tmpOE__otherUnused_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__otherUnused_net[0:0]}),
		  .io({tmpIO_0__otherUnused_net[0:0]}),
		  .siovref(tmpSIOVREF__otherUnused_net),
		  .interrupt({tmpINTERRUPT_0__otherUnused_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__otherUnused_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1a6cdb9e-56d7-4f88-aca9-dd1916d20fe6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_7 SPIM_2 (
        ...
        .mosi(Net_1180),
        .reset(1'b0),
        .rx_interrupt(Net_1176),
        .sclk(Net_1181),
        .sdat(Net_1177),
        .ss(Net_1182),
        .tx_interrupt(Net_1178));
	...
	cy_psoc3_pins_v1_10
		#(.id("eecafb34-0427-4a62-b0b1-71b47078c4f5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f7c837f-4748-4cae-88c9-cb3a402a26d9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("49cf4458-dc98-4095-913b-b3d235a69e3a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ac4354eb-c8f5-4f51-946b-977483cfe335"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
