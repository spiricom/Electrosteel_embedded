...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USB_1_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USB_1_DEVICE0_CONFIGURATION0_DESCR[101u] = {
...
*********************************************************************/
const uint8 CYCODE USB_1_STRING_DESCRIPTORS[219u] = {
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "Snyderphonics Electrosteel"
*********************************************************************/
...
/* DescriptorType: STRING                  */ 0x03u,
 ...
 (uint8)'i', 0u,(uint8)'c', 0u,(uint8)'s', 0u,(uint8)' ', 0u,(uint8)'E', 0u,
 (uint8)'l', 0u,(uint8)'e', 0u,(uint8)'c', 0u,(uint8)'t', 0u,(uint8)'r', 0u,
 (uint8)'o', 0u,(uint8)'s', 0u,(uint8)'t', 0u,(uint8)'e', 0u,(uint8)'e', 0u,
 (uint8)'l', 0u,
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "Electrosteel IN"
*********************************************************************/
/* Descriptor Length                       */ 0x20u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'E', 0u,(uint8)'l', 0u,(uint8)'e', 0u,(uint8)'c', 0u,(uint8)'t', 0u,
 (uint8)'r', 0u,(uint8)'o', 0u,(uint8)'s', 0u,(uint8)'t', 0u,(uint8)'e', 0u,
 (uint8)'e', 0u,(uint8)'l', 0u,(uint8)' ', 0u,(uint8)'I', 0u,(uint8)'N', 0u,
/*********************************************************************
* String Descriptor: "Electrosteel OUT"
*********************************************************************/
/* Descriptor Length                       */ 0x22u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'E', 0u,(uint8)'l', 0u,(uint8)'e', 0u,(uint8)'c', 0u,(uint8)'t', 0u,
 (uint8)'r', 0u,(uint8)'o', 0u,(uint8)'s', 0u,(uint8)'t', 0u,(uint8)'e', 0u,
 (uint8)'e', 0u,(uint8)'l', 0u,(uint8)' ', 0u,(uint8)'O', 0u,(uint8)'U', 0u,
 (uint8)'T', 0u,
/*********************************************************************/
...
*********************************************************************/
const uint8 CYCODE USB_1_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_USB_1_EP_SETTINGS_BLOCK CYCODE USB_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[2u] = {
/* IFC  ALT    EPAddr bmAttr MaxPktSize Class ********************/
{0x01u, 0x00u, 0x81u, 0x02u, 0x0020u,   0x01u},
{0x01u, 0x00u, 0x02u, 0x02u, 0x0020u,   0x01u}
};
const uint8 CYCODE USB_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[2u] = {
0x01u, 0x01u
};
/*********************************************************************
...
*********************************************************************/
const T_USB_1_LUT CYCODE USB_1_DEVICE0_CONFIGURATION0_TABLE[5u] = {
    {0x01u,     &USB_1_DEVICE0_CONFIGURATION0_DESCR},
    {0x02u,     &USB_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &USB_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USB_1_LUT CYCODE USB_1_DEVICE0_TABLE[3u] = {
    {0x01u,     &USB_1_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &USB_1_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USB_1_LUT CYCODE USB_1_TABLE[1u] = {
    {0x01u,     &USB_1_DEVICE0_TABLE}
};
    ...
    *  USB_1_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USB_1_MSOS_DESCRIPTOR[USB_1_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USB_1_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USB_1_MSOS_CONFIGURATION_DESCR[USB_1_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USB_1_idSerialNumberStringDescriptor[USB_1_IDSN_DESCR_LENGTH];
