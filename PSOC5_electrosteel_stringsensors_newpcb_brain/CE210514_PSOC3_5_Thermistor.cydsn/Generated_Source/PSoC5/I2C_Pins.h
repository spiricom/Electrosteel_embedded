...
void    I2C_Pins_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the I2C_Pins_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(I2C_Pins__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in I2C_Pins_SetInterruptMode() function.
     *  @{
     */
        #define I2C_Pins_INTR_NONE      (uint16)(0x0000u)
        #define I2C_Pins_INTR_RISING    (uint16)(0x0001u)
        #define I2C_Pins_INTR_FALLING   (uint16)(0x0002u)
        #define I2C_Pins_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define I2C_Pins_INTR_MASK      (0x01u) 
#endif /* (I2C_Pins__INTSTAT) */
...
/* SIO registers */
#if defined(I2C_Pins__SIO_CFG)
    #define I2C_Pins_SIO_HYST_EN        (* (reg8 *) I2C_Pins__SIO_HYST_EN)
    #define I2C_Pins_SIO_REG_HIFREQ     (* (reg8 *) I2C_Pins__SIO_REG_HIFREQ)
    #define I2C_Pins_SIO_CFG            (* (reg8 *) I2C_Pins__SIO_CFG)
    #define I2C_Pins_SIO_DIFF           (* (reg8 *) I2C_Pins__SIO_DIFF)
#endif /* (I2C_Pins__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define I2C_Pins_0_INTTYPE_REG 		(* (reg8 *) I2C_Pins__0__INTTYPE)
	#define I2C_Pins_1_INTTYPE_REG 		(* (reg8 *) I2C_Pins__1__INTTYPE)
#endif /* (I2C_Pins__INTSTAT) */
