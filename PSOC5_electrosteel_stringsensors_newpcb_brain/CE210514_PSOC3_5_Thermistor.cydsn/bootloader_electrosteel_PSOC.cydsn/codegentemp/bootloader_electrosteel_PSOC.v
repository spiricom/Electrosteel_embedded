// ======================================================================
// bootloader_electrosteel_PSOC.v generated from TopDesign.cysch
// 07/27/2023 at 15:53
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e22d673a-8b0c-485e-ba43-9c5904d579c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a6e3e87e-ab84-4153-927f-5b872a5a6621"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("862603ed-7430-49ac-81bf-2e3a4fb62a08"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3d8c72d1-afa0-42bd-81d0-20d0390a655f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("febb7001-131a-49ba-b297-ff488a965eaa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d13ccda8-f132-4729-b61c-5e907c7d7cb9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RedLED2_net;
	wire [0:0] tmpFB_0__RedLED2_net;
	wire [0:0] tmpIO_0__RedLED2_net;
	wire [0:0] tmpINTERRUPT_0__RedLED2_net;
	electrical [0:0] tmpSIOVREF__RedLED2_net;

	cy_psoc3_pins_v1_10
		#(.id("228fc4ca-c6b9-4999-8e8f-3450794f644e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RedLED2
		 (.oe(tmpOE__RedLED2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RedLED2_net[0:0]}),
		  .io({tmpIO_0__RedLED2_net[0:0]}),
		  .siovref(tmpSIOVREF__RedLED2_net),
		  .interrupt({tmpINTERRUPT_0__RedLED2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RedLED2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GreenLED2_net;
	wire [0:0] tmpFB_0__GreenLED2_net;
	wire [0:0] tmpIO_0__GreenLED2_net;
	wire [0:0] tmpINTERRUPT_0__GreenLED2_net;
	electrical [0:0] tmpSIOVREF__GreenLED2_net;

	cy_psoc3_pins_v1_10
		#(.id("8826aa1f-93e3-477f-99ed-a241bfa67f48"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GreenLED2
		 (.oe(tmpOE__GreenLED2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GreenLED2_net[0:0]}),
		  .io({tmpIO_0__GreenLED2_net[0:0]}),
		  .siovref(tmpSIOVREF__GreenLED2_net),
		  .interrupt({tmpINTERRUPT_0__GreenLED2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GreenLED2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
