...
module ADC_SAR_SEQ_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("ed7ddc83-dba6-48b0-842d-889008c1ed25/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("ed7ddc83-dba6-48b0-842d-889008c1ed25/3d23b625-9a71-4c05-baf4-2f904356009b"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
...
module SPI_Slave_v2_70_4 (
	...
	cy_clock_v1_0
		#(.id("dedf51f5-d9e4-419a-97c3-7e15d17c7481/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000"),
		  .is_direct(0),
...
module SPI_Slave_v2_70_5 (
	...
	cy_clock_v1_0
		#(.id("8042e3b0-895e-41c1-994d-e8098f423636/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("304878048.780488"),
		  .is_direct(0),
		  .is_digital(1))
		IntClock
		 (.clock_out(Net_176));
...
// QuadDecoder_SW_v0_2(btn_enable=false, check_bounds=false, encoder_range=1, gnd_enable=false, increment=1, input_mode=0, invert_dir=false, lower_bound=-128, start_position=0, state_check=1, timer_isr=0, upper_bound=127, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=QuadDecoder_SW_v0_2, CY_CONFIG_TITLE=Decoder_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Decoder_1, CY_INSTANCE_SHORT_NAME=Decoder_1, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=2, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Decoder_1, )
module QuadDecoder_SW_v0_2_7 (
    A,
    B,
    btn,
    clk,
	...
	wire [1:0] tmpOE__PINS2_net;
	wire [1:0] tmpFB_1__PINS2_net;
	wire [1:0] tmpIO_1__PINS2_net;
	electrical [0:0] tmpSIOVREF__PINS2_net;

	cy_psoc3_pins_v1_10
		#(.id("117c6fee-0072-47af-a0ea-df349d08cc32/99b2ba3c-7567-4c37-ba64-5939f925dead"),
		...
		PINS2
		 (.oe(tmpOE__PINS2_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__PINS2_net[1:0]}),
		  .io({tmpIO_1__PINS2_net[1:0]}),
		  .siovref(tmpSIOVREF__PINS2_net),
		  .interrupt({Net_164}),
		  .annotation({Net_202, Net_201}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PINS2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

	// VirtualMux_1 (cy_virtualmux_v1_0)
	assign Net_163 = Net_164;
...
module top ;
	...
	wire [0:0] tmpOE__MISO_3_net;
	wire [0:0] tmpFB_0__MISO_3_net;
	wire [0:0] tmpIO_0__MISO_3_net;
	wire [0:0] tmpINTERRUPT_0__MISO_3_net;
	electrical [0:0] tmpSIOVREF__MISO_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0d8f928a-48a1-414e-9d39-f8b057e5f199"),
		  ...
		  .input_buffer_sel(2'b00))
		MISO_3
		 (.oe(tmpOE__MISO_3_net),
		  .y({Net_1160}),
		  .fb({tmpFB_0__MISO_3_net[0:0]}),
		  .io({tmpIO_0__MISO_3_net[0:0]}),
		  .siovref(tmpSIOVREF__MISO_3_net),
		  .interrupt({tmpINTERRUPT_0__MISO_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MISO_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    SPI_Master_v2_50_0 SPIM_1 (
        ...
        .mosi(Net_1042),
        .reset(1'b0),
        .rx_interrupt(Net_1497),
        .sclk(Net_415),
        .sdat(Net_1044),
        .ss(Net_437),
        .tx_interrupt(Net_1500));
	...
	wire [0:0] tmpOE__joy_y_net;
	wire [0:0] tmpFB_0__joy_y_net;
	wire [0:0] tmpIO_0__joy_y_net;
	wire [0:0] tmpINTERRUPT_0__joy_y_net;
	electrical [0:0] tmpSIOVREF__joy_y_net;
	...
	cy_psoc3_pins_v1_10
		...
		joy_y
		 (.oe(tmpOE__joy_y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__joy_y_net[0:0]}),
		  .analog({Net_540}),
		  .io({tmpIO_0__joy_y_net[0:0]}),
		  .siovref(tmpSIOVREF__joy_y_net),
		  .interrupt({tmpINTERRUPT_0__joy_y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__joy_y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__joy_x_net;
	wire [0:0] tmpFB_0__joy_x_net;
	wire [0:0] tmpIO_0__joy_x_net;
	wire [0:0] tmpINTERRUPT_0__joy_x_net;
	electrical [0:0] tmpSIOVREF__joy_x_net;
	...
	cy_psoc3_pins_v1_10
		...
		joy_x
		 (.oe(tmpOE__joy_x_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__joy_x_net[0:0]}),
		  .analog({Net_636}),
		  .io({tmpIO_0__joy_x_net[0:0]}),
		  .siovref(tmpSIOVREF__joy_x_net),
		  .interrupt({tmpINTERRUPT_0__joy_x_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__joy_x_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SCLK_3_net;
	wire [0:0] tmpIO_0__SCLK_3_net;
	wire [0:0] tmpINTERRUPT_0__SCLK_3_net;
	electrical [0:0] tmpSIOVREF__SCLK_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ccb4b1af-44d7-4abf-83e7-3ec4093243bc"),
		  ...
		  .input_buffer_sel(2'b00))
		SCLK_3
		 (.oe(tmpOE__SCLK_3_net),
		  .y({1'b0}),
		  .fb({Net_1449}),
		  .io({tmpIO_0__SCLK_3_net[0:0]}),
		  .siovref(tmpSIOVREF__SCLK_3_net),
		  .interrupt({tmpINTERRUPT_0__SCLK_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCLK_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MOSI_3_net;
	wire [0:0] tmpIO_0__MOSI_3_net;
	wire [0:0] tmpINTERRUPT_0__MOSI_3_net;
	electrical [0:0] tmpSIOVREF__MOSI_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("549e9c7b-fd0b-4dad-b221-5401b1acd680"),
		  ...
		  .input_buffer_sel(2'b00))
		MOSI_3
		 (.oe(tmpOE__MOSI_3_net),
		  .y({1'b0}),
		  .fb({Net_1157}),
		  .io({tmpIO_0__MOSI_3_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSI_3_net),
		  .interrupt({tmpINTERRUPT_0__MOSI_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSI_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SPI_Slave_v2_70_4 SPIS_2 (
        .clock(1'b0),
        .miso(Net_1160),
        .miso_oe(Net_1165),
        .mosi(Net_1157),
        .reset(1'b0),
        .rx_interrupt(Net_1369),
        .sclk(Net_1449),
        .sdat(Net_1163),
        .ss(Net_1455),
        .tx_interrupt(Net_1162));
    defparam SPIS_2.NumberOfDataBits = 8;
    defparam SPIS_2.ShiftDir = 0;

	wire [0:0] tmpOE__knob2_net;
	wire [0:0] tmpFB_0__knob2_net;
	wire [0:0] tmpIO_0__knob2_net;
	wire [0:0] tmpINTERRUPT_0__knob2_net;
	electrical [0:0] tmpSIOVREF__knob2_net;
	...
	cy_psoc3_pins_v1_10
		...
		knob2
		 (.oe(tmpOE__knob2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__knob2_net[0:0]}),
		  .analog({Net_537}),
		  .io({tmpIO_0__knob2_net[0:0]}),
		  .siovref(tmpSIOVREF__knob2_net),
		  .interrupt({tmpINTERRUPT_0__knob2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__knob2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__knob1_net;
	wire [0:0] tmpFB_0__knob1_net;
	wire [0:0] tmpIO_0__knob1_net;
	wire [0:0] tmpINTERRUPT_0__knob1_net;
	electrical [0:0] tmpSIOVREF__knob1_net;
	...
	cy_psoc3_pins_v1_10
		...
		knob1
		 (.oe(tmpOE__knob1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__knob1_net[0:0]}),
		  .analog({Net_536}),
		  .io({tmpIO_0__knob1_net[0:0]}),
		  .siovref(tmpSIOVREF__knob1_net),
		  .interrupt({tmpINTERRUPT_0__knob1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__knob1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MISO_2_net;
	wire [0:0] tmpFB_0__MISO_2_net;
	...
	wire [0:0] tmpOE__testpin6_net;
	wire [0:0] tmpFB_0__testpin6_net;
	wire [0:0] tmpIO_0__testpin6_net;
	wire [0:0] tmpINTERRUPT_0__testpin6_net;
	electrical [0:0] tmpSIOVREF__testpin6_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a7449aa1-4665-45f8-b7c2-e078a15fe67f"),
		  ...
		  .input_buffer_sel(2'b00))
		testpin6
		 (.oe(tmpOE__testpin6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__testpin6_net[0:0]}),
		  .io({tmpIO_0__testpin6_net[0:0]}),
		  .siovref(tmpSIOVREF__testpin6_net),
		  .interrupt({tmpINTERRUPT_0__testpin6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__testpin6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__oct1_net;
	wire [0:0] tmpIO_0__oct1_net;
	wire [0:0] tmpINTERRUPT_0__oct1_net;
	electrical [0:0] tmpSIOVREF__oct1_net;
	...
	cy_psoc3_pins_v1_10
		...
		oct1
		 (.oe(tmpOE__oct1_net),
		  .y({1'b0}),
		  .fb({Net_1560[4]}),
		  .io({tmpIO_0__oct1_net[0:0]}),
		  .siovref(tmpSIOVREF__oct1_net),
		  .interrupt({tmpINTERRUPT_0__oct1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__oct1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SPI_Slave_v2_70_5 SPIS_1 (
        .clock(1'b0),
        .miso(Net_1344),
        .miso_oe(Net_1349),
        .mosi(Net_1295),
        .reset(1'b0),
        .rx_interrupt(Net_1362),
        .sclk(Net_1342),
        .sdat(Net_1347),
        .ss(Net_1467),
        .tx_interrupt(Net_1346));
    defparam SPIS_1.NumberOfDataBits = 8;
    defparam SPIS_1.ShiftDir = 0;

	wire [0:0] tmpOE__oct2_net;
	wire [0:0] tmpFB_0__oct2_net;
	wire [0:0] tmpIO_0__oct2_net;
	wire [0:0] tmpINTERRUPT_0__oct2_net;
	electrical [0:0] tmpSIOVREF__oct2_net;
	...
	cy_psoc3_pins_v1_10
		...
		oct2
		 (.oe(tmpOE__oct2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__oct2_net[0:0]}),
		  .io({tmpIO_0__oct2_net[0:0]}),
		  .siovref(tmpSIOVREF__oct2_net),
		  .interrupt({tmpINTERRUPT_0__oct2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__oct2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__oct3_net;
	wire [0:0] tmpFB_0__oct3_net;
	wire [0:0] tmpIO_0__oct3_net;
	wire [0:0] tmpINTERRUPT_0__oct3_net;
	electrical [0:0] tmpSIOVREF__oct3_net;
	...
	cy_psoc3_pins_v1_10
		...
		oct3
		 (.oe(tmpOE__oct3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__oct3_net[0:0]}),
		  .io({tmpIO_0__oct3_net[0:0]}),
		  .siovref(tmpSIOVREF__oct3_net),
		  .interrupt({tmpINTERRUPT_0__oct3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__oct3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__oct4_net;
	wire [0:0] tmpIO_0__oct4_net;
	wire [0:0] tmpINTERRUPT_0__oct4_net;
	electrical [0:0] tmpSIOVREF__oct4_net;
	...
	cy_psoc3_pins_v1_10
		...
		oct4
		 (.oe(tmpOE__oct4_net),
		  .y({1'b0}),
		  .fb({Net_1560[5]}),
		  .io({tmpIO_0__oct4_net[0:0]}),
		  .siovref(tmpSIOVREF__oct4_net),
		  .interrupt({tmpINTERRUPT_0__oct4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__oct4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__testpin4_net;
	wire [0:0] tmpFB_0__testpin4_net;
	wire [0:0] tmpIO_0__testpin4_net;
	wire [0:0] tmpINTERRUPT_0__testpin4_net;
	electrical [0:0] tmpSIOVREF__testpin4_net;
	...
	cy_psoc3_pins_v1_10
		...
		testpin4
		 (.oe(tmpOE__testpin4_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__testpin4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__testpin4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__testpin2_net;
	wire [0:0] tmpFB_0__testpin2_net;
	wire [0:0] tmpIO_0__testpin2_net;
	wire [0:0] tmpINTERRUPT_0__testpin2_net;
	electrical [0:0] tmpSIOVREF__testpin2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4f548301-42ad-4954-a7c3-d576b3c2dc79"),
		  ...
		  .input_buffer_sel(2'b00))
		testpin2
		 (.oe(tmpOE__testpin2_net),
		  .y({Net_1460}),
		  .fb({tmpFB_0__testpin2_net[0:0]}),
		  .io({tmpIO_0__testpin2_net[0:0]}),
		  .siovref(tmpSIOVREF__testpin2_net),
		  .interrupt({tmpINTERRUPT_0__testpin2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__testpin2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__testpin3_net;
	wire [0:0] tmpFB_0__testpin3_net;
	wire [0:0] tmpIO_0__testpin3_net;
	wire [0:0] tmpINTERRUPT_0__testpin3_net;
	electrical [0:0] tmpSIOVREF__testpin3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3b42db52-c059-4368-a414-bbfe4d141e84"),
		  ...
		  .input_buffer_sel(2'b00))
		testpin3
		 (.oe(tmpOE__testpin3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__testpin3_net[0:0]}),
		  .io({tmpIO_0__testpin3_net[0:0]}),
		  .siovref(tmpSIOVREF__testpin3_net),
		  .interrupt({tmpINTERRUPT_0__testpin3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__testpin3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__testpin1_net;
	wire [0:0] tmpFB_0__testpin1_net;
	wire [0:0] tmpIO_0__testpin1_net;
	wire [0:0] tmpINTERRUPT_0__testpin1_net;
	electrical [0:0] tmpSIOVREF__testpin1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f14e4142-0738-45ff-a72b-5931a1a679b0"),
		  ...
		  .input_buffer_sel(2'b00))
		testpin1
		 (.oe(tmpOE__testpin1_net),
		  .y({Net_1369}),
		  .fb({tmpFB_0__testpin1_net[0:0]}),
		  .io({tmpIO_0__testpin1_net[0:0]}),
		  .siovref(tmpSIOVREF__testpin1_net),
		  .interrupt({tmpINTERRUPT_0__testpin1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__testpin1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__testpin5_net;
	wire [0:0] tmpFB_0__testpin5_net;
	wire [0:0] tmpIO_0__testpin5_net;
	wire [0:0] tmpINTERRUPT_0__testpin5_net;
	electrical [0:0] tmpSIOVREF__testpin5_net;
	...
	cy_psoc3_pins_v1_10
		...
		testpin5
		 (.oe(tmpOE__testpin5_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__testpin5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__LED_TEST_net;
	wire [0:0] tmpFB_0__LED_TEST_net;
	wire [0:0] tmpIO_0__LED_TEST_net;
	wire [0:0] tmpINTERRUPT_0__LED_TEST_net;
	electrical [0:0] tmpSIOVREF__LED_TEST_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e2322002-b5d9-47ff-8de8-a5efe0286e8b"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_TEST
		 (.oe(tmpOE__LED_TEST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_TEST_net[0:0]}),
		  .io({tmpIO_0__LED_TEST_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_TEST_net),
		  .interrupt({tmpINTERRUPT_0__LED_TEST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_TEST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_green1_net;
	wire [0:0] tmpFB_0__LED_green1_net;
	wire [0:0] tmpIO_0__LED_green1_net;
	wire [0:0] tmpINTERRUPT_0__LED_green1_net;
	electrical [0:0] tmpSIOVREF__LED_green1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("55244eb4-edd4-4d57-8b15-a39acddc07bc"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_green1
		 (.oe(tmpOE__LED_green1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_green1_net[0:0]}),
		  .io({tmpIO_0__LED_green1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_green1_net),
		  .interrupt({tmpINTERRUPT_0__LED_green1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_green1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_amber1_net;
	wire [0:0] tmpFB_0__LED_amber1_net;
	wire [0:0] tmpIO_0__LED_amber1_net;
	wire [0:0] tmpINTERRUPT_0__LED_amber1_net;
	electrical [0:0] tmpSIOVREF__LED_amber1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("771b535f-958d-4cf6-8e9d-889c3c3b71f7"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_amber1
		 (.oe(tmpOE__LED_amber1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_amber1_net[0:0]}),
		  .io({tmpIO_0__LED_amber1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_amber1_net),
		  .interrupt({tmpINTERRUPT_0__LED_amber1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_amber1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_amber2_net;
	wire [0:0] tmpFB_0__LED_amber2_net;
	wire [0:0] tmpIO_0__LED_amber2_net;
	wire [0:0] tmpINTERRUPT_0__LED_amber2_net;
	electrical [0:0] tmpSIOVREF__LED_amber2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("546caf64-f30f-4f45-aa81-61975d8c217f"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_amber2
		 (.oe(tmpOE__LED_amber2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_amber2_net[0:0]}),
		  .io({tmpIO_0__LED_amber2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_amber2_net),
		  .interrupt({tmpINTERRUPT_0__LED_amber2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_amber2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_amber3_net;
	wire [0:0] tmpFB_0__LED_amber3_net;
	wire [0:0] tmpIO_0__LED_amber3_net;
	wire [0:0] tmpINTERRUPT_0__LED_amber3_net;
	electrical [0:0] tmpSIOVREF__LED_amber3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f011145e-bf58-4aad-b58d-31a222c41de0"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_amber3
		 (.oe(tmpOE__LED_amber3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_amber3_net[0:0]}),
		  .io({tmpIO_0__LED_amber3_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_amber3_net),
		  .interrupt({tmpINTERRUPT_0__LED_amber3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_amber3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_amber4_net;
	wire [0:0] tmpFB_0__LED_amber4_net;
	wire [0:0] tmpIO_0__LED_amber4_net;
	wire [0:0] tmpINTERRUPT_0__LED_amber4_net;
	electrical [0:0] tmpSIOVREF__LED_amber4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ea3ad312-60b9-47ef-a903-e5186264e3b9"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_amber4
		 (.oe(tmpOE__LED_amber4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_amber4_net[0:0]}),
		  .io({tmpIO_0__LED_amber4_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_amber4_net),
		  .interrupt({tmpINTERRUPT_0__LED_amber4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_amber4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_red1_net;
	wire [0:0] tmpFB_0__LED_red1_net;
	wire [0:0] tmpIO_0__LED_red1_net;
	wire [0:0] tmpINTERRUPT_0__LED_red1_net;
	electrical [0:0] tmpSIOVREF__LED_red1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5c96cbd9-5bfd-4f3b-a31e-86ca082dc465"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_red1
		 (.oe(tmpOE__LED_red1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_red1_net[0:0]}),
		  .io({tmpIO_0__LED_red1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_red1_net),
		  .interrupt({tmpINTERRUPT_0__LED_red1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_red1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_red2_net;
	wire [0:0] tmpFB_0__LED_red2_net;
	wire [0:0] tmpIO_0__LED_red2_net;
	wire [0:0] tmpINTERRUPT_0__LED_red2_net;
	electrical [0:0] tmpSIOVREF__LED_red2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f39b8423-f8ec-4abc-b37f-a40d6fb109fc"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_red2
		 (.oe(tmpOE__LED_red2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_red2_net[0:0]}),
		  .io({tmpIO_0__LED_red2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_red2_net),
		  .interrupt({tmpINTERRUPT_0__LED_red2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_red2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_green2_net;
	wire [0:0] tmpFB_0__LED_green2_net;
	wire [0:0] tmpIO_0__LED_green2_net;
	wire [0:0] tmpINTERRUPT_0__LED_green2_net;
	electrical [0:0] tmpSIOVREF__LED_green2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d0e1f8ef-f4ef-434f-b78f-3318880d935c"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_green2
		 (.oe(tmpOE__LED_green2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_green2_net[0:0]}),
		  .io({tmpIO_0__LED_green2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_green2_net),
		  .interrupt({tmpINTERRUPT_0__LED_green2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_green2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("271219c8-37ab-436e-87bd-68fc687a52af"),
    ...
    QuadDecoder_SW_v0_2_7 Decoder_1 (
        .A(Net_1626),
        .B(Net_1625),
        .btn(Net_1624),
        .clk(1'b0),
	...
	wire [0:0] tmpOE__encoder_button_net;
	wire [0:0] tmpIO_0__encoder_button_net;
	wire [0:0] tmpINTERRUPT_0__encoder_button_net;
	electrical [0:0] tmpSIOVREF__encoder_button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("456e0cd5-0469-4f32-82ec-af9d5387b2ab"),
		  ...
		  .input_buffer_sel(2'b00))
		encoder_button
		 (.oe(tmpOE__encoder_button_net),
		  .y({1'b0}),
		  .fb({Net_1560[7]}),
		  .io({tmpIO_0__encoder_button_net[0:0]}),
		  .siovref(tmpSIOVREF__encoder_button_net),
		  .interrupt({tmpINTERRUPT_0__encoder_button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__encoder_button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__neck1_button_net;
	wire [0:0] tmpFB_0__neck1_button_net;
	wire [0:0] tmpIO_0__neck1_button_net;
	wire [0:0] tmpINTERRUPT_0__neck1_button_net;
	electrical [0:0] tmpSIOVREF__neck1_button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("01e0b30a-9242-4bf9-8c2f-b3874fdfdeea"),
		  ...
		  .input_buffer_sel(2'b00))
		neck1_button
		 (.oe(tmpOE__neck1_button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__neck1_button_net[0:0]}),
		  .io({tmpIO_0__neck1_button_net[0:0]}),
		  .siovref(tmpSIOVREF__neck1_button_net),
		  .interrupt({tmpINTERRUPT_0__neck1_button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__neck1_button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__neck2_button_net;
	wire [0:0] tmpFB_0__neck2_button_net;
	wire [0:0] tmpIO_0__neck2_button_net;
	wire [0:0] tmpINTERRUPT_0__neck2_button_net;
	electrical [0:0] tmpSIOVREF__neck2_button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a4d14ee2-c07d-4d5d-ad15-28e445147068"),
		  ...
		  .input_buffer_sel(2'b00))
		neck2_button
		 (.oe(tmpOE__neck2_button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__neck2_button_net[0:0]}),
		  .io({tmpIO_0__neck2_button_net[0:0]}),
		  .siovref(tmpSIOVREF__neck2_button_net),
		  .interrupt({tmpINTERRUPT_0__neck2_button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__neck2_button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__shift_button_net;
	wire [0:0] tmpIO_0__shift_button_net;
	wire [0:0] tmpINTERRUPT_0__shift_button_net;
	electrical [0:0] tmpSIOVREF__shift_button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4aa02dfa-0991-4d63-903d-1e8b9712c6c0"),
		  ...
		  .input_buffer_sel(2'b00))
		shift_button
		 (.oe(tmpOE__shift_button_net),
		  .y({1'b0}),
		  .fb({Net_1560[6]}),
		  .io({tmpIO_0__shift_button_net[0:0]}),
		  .siovref(tmpSIOVREF__shift_button_net),
		  .interrupt({tmpINTERRUPT_0__shift_button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__shift_button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__edit_button_net;
	wire [0:0] tmpFB_0__edit_button_net;
	wire [0:0] tmpIO_0__edit_button_net;
	wire [0:0] tmpINTERRUPT_0__edit_button_net;
	electrical [0:0] tmpSIOVREF__edit_button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("af82adba-aaa6-4d9f-860d-de43c430927a"),
		  ...
		  .input_buffer_sel(2'b00))
		edit_button
		 (.oe(tmpOE__edit_button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__edit_button_net[0:0]}),
		  .io({tmpIO_0__edit_button_net[0:0]}),
		  .siovref(tmpSIOVREF__edit_button_net),
		  .interrupt({tmpINTERRUPT_0__edit_button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__edit_button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("48dc1363-538d-450c-ad1c-315b5fcf0983"),
