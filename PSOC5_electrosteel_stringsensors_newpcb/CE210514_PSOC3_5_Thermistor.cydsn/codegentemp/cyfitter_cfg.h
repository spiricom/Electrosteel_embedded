...
/* AMux_1_CYAMUXSIDE_A__addrTable is an implementation detail of the AMux.
   ...
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE AMux_1_CYAMUXSIDE_A__addrTable[6];
/* AMux_1_CYAMUXSIDE_A__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE AMux_1_CYAMUXSIDE_A__maskTable[6];
...
/* AMux_1_CYAMUXSIDE_B__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE AMux_1_CYAMUXSIDE_B__addrTable[6];
/* AMux_1_CYAMUXSIDE_B__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE AMux_1_CYAMUXSIDE_B__maskTable[6];
...
/* CapSense_AMuxCH0__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE CapSense_AMuxCH0__addrTable[15];
/* CapSense_AMuxCH0__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE CapSense_AMuxCH0__maskTable[15];
