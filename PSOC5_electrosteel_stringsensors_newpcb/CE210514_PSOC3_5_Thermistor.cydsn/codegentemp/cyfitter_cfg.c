...
#define BS_UDB_1_4_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000028u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 640u, 0x0Bu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 10 */
		...
		{ 128u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE) },	/* TD 19 */
		...
		{ 7u, 0x18u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT6_BASE) },	/* TD 23 */
		{ 64u, 0x19u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UWRK_UWRK8_B0_BASE) },	/* TD 24 */
		...
		{ 128u, 0x3Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE) },	/* TD 60 */
		{ 128u, 0x3Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE + 0x00000080u) },	/* TD 61 */
		{ 128u, 0x3Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE + 0x00000080u) },	/* TD 62 */
		{ 128u, 0x40u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE) },	/* TD 63 */
		{ 128u, 0x41u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE + 0x00000080u) },	/* TD 64 */
		{ 128u, 0x42u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_ROUTE_BASE) },	/* TD 65 */
		{ 128u, 0x43u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_ROUTE_BASE + 0x00000080u) },	/* TD 66 */
		{ 128u, 0x44u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P7_ROUTE_BASE) },	/* TD 67 */
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_IOPORT_6_VAL),	/* TD 23 */
		...
		(const void *)(BS_UDBSWITCH_0_4_VAL),	/* TD 63 */
		(const void *)(BS_UDB_1_4_HV_ROUTING_VAL),	/* TD 64 */
		(const void *)(BS_UDBSWITCH_1_4_VAL),	/* TD 65 */
		(const void *)(BS_UDB_2_4_HV_ROUTING_VAL),	/* TD 66 */
		(const void *)(BS_UDBSWITCH_0_5_VAL),	/* TD 67 */
...
uint8 CYXDATA * const CYCODE AMux_2__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CYREG_DAC3_SW3, 
	(uint8 CYXDATA *)CYREG_BUS_SW0, (uint8 CYXDATA *)CYREG_DAC3_SW4, 
};
