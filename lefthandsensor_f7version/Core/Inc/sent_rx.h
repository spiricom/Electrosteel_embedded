...
typedef void (*SENTRxCallback_t)(SENTRxHandle_t *const handle, SENTMsg_t *const msg, void *user_data);
typedef void (*SENTRxSlowCallback_t)(SENTRxHandle_t *const handle, SENTSlowMsg_t *const msg, void *user_data);
