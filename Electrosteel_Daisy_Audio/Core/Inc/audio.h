...
typedef void (*shapeTick_t)(float*, uint_fast8_t v, float freq, float, uint_fast8_t, uint_fast8_t string);
typedef void (*lfoShapeTick_t)(float*, uint_fast8_t v, uint_fast8_t string);
...
typedef void (*filterTick_t)(float*, uint_fast8_t, float, uint_fast8_t);
