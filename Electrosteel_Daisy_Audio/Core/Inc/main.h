...
extern uint_fast8_t currentLeverBuffer;
#define MAX_NUM_PRESETS 64
extern float midiKeyDivisor;
extern float midiKeySubtractor;
extern uint_fast8_t  effectsActive[4];
extern volatile uint_fast8_t  currentActivePreset;
...
extern uint_fast8_t  fxPre;
extern uint_fast8_t  pedalControlsMaster;
extern uint_fast8_t  numMappings;
extern uint_fast8_t  diskBusy;
extern uint_fast8_t  volatile interruptChecker;
extern float random_values[256];
extern volatile uint_fast32_t presetWaitingToLoad;
extern volatile uint_fast8_t  presetNumberToLoad;
extern uint_fast8_t  boardNumber;
extern uint_fast8_t  currentRandom;
extern uint_fast8_t  receivingI2C;
