...
extern tDynamicSmoother knobSmoothers[20];
extern tDynamicSmoother pedalSmoothers[10];
...
extern tDynamicSmoother volumeSmoother;
extern tDynamicSmoother pitchSmoother[NUM_OSC][NUM_STRINGS_PER_BOARD];
extern float barInMIDI[2];
extern float prevBarInMIDI[2];
extern tDynamicSmoother barSlideSmoother[NUM_STRINGS_PER_BOARD];
